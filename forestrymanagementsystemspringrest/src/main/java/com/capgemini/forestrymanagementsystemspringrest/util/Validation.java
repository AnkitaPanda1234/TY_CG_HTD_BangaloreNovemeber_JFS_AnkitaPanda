package com.capgemini.forestrymanagementsystemspringrest.util;
...
public class Validation {
	...
	// String names = "pinki panda";
	// String date2 = "01-01-2020";//
	// String valueValidation="200";
	// boolean flag = validObj.valueValidation(valueValidation);
